...
export default function ProjectCard(props: ProjectCardProps) {
    return (
        <div
            className="flex flex-col justify-between rounded-xl border-[1px] border-stone-600 shadow-lg shadow-black text-white max-w-[22rem] md:max-w-sm px-8 pt-8 pb-2"
        >
