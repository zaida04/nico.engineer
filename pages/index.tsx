...
const Home: NextPage<Props> = ({ animeCount, timeCoding }) => {
    return (
        <div className="h-full w-full flex items-center ">
            <div className="md:flex md:px-40 md:pt-32 px-10 py-20">
                <div className="text-xl leading-loose text-gray-400 max-w-3xl space-y-6">
                    ...
                    <p>
                        ...
                        <a className="text-green-600 hover:underline" href="https://nodejs.org/en/">
                            Node.js
                        </a>
                        ,{" "}
                        <a className="text-yellow-300  hover:underline" href="https://www.javascript.com/">
                            JavaScript
                        </a>
                        ,{" "}
                        <a className="text-blue-700  hover:underline" href="https://www.typescriptlang.org/">
                            TypeScript
                        </a>
                        , and{" "}
                    ...
                    <p>
                        ...
                        <a className="text-red-600 hover:underline" href="https://www.rust-lang.org/">
                            Rust
                        </a>{" "}
                        and scalable languages like{" "}
                        <a className="text-purple-700 hover:underline" href="https://elixir-lang.org/">
                            Elixir
                        </a>
                    </p>
                    <p>
                    ...
                    <a href="https://github.com/zaida04">GitHub</a>
                    <a href="https://discord.com/users/500765481788112916/">Discord</a>
                </div>
