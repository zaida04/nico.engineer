export const AWS_SERVICES = [
  ...
  },
  {
    ...
    "description": "Securely launch AWS resources in a virtual network. Isolate and control your cloud resources using customizable networking configurations.",
    "aliases": ["VPC"],
  ...
  {
    "name": "CloudWatch",
    "description": "Monitoring and observability service for AWS resources and applications. Collect and analyze metrics, set alarms, and gain insights into system performance.",
  ...
  {
    "name": "DynamoDB",
    "description": "Fully managed NoSQL database for any scale of applications. Fast and reliable, perfect for handling large volumes of data with low latency.",
